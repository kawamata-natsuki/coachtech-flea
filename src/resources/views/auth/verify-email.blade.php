...
<div class="verify-email-page">
  ...
  <!-- 認証確認 -->
  <form class="verify-email-page__form verify-email-page__form--confirm" method="GET"
  ...
  <!-- 認証メール再送信 -->
  <form class="verify-email-page__form verify-email-page__form--resend" method="POST"
